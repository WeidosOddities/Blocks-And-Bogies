...
public class ExtraLargeSingleAxle extends ExtraLargeBogieBlock {
    public ExtraLargeSingleAxle(Properties props) {
        super(props, BogieStyles.SINGLE_AXLE_PISTONLESS, BogeySizes.LARGE);
    }

...
public class LargeTripleAxle extends LargeBogieBlock {
    public LargeTripleAxle(Properties props) {
        super(props, BogieStyles.TRIPLE_AXLE_PISTONLESS, BogeySizes.SMALL);
    }

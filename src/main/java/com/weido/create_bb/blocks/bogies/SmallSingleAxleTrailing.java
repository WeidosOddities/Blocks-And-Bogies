...
public class SmallSingleAxleTrailing extends SmallBogieBlock {
    public SmallSingleAxleTrailing(Properties props) {
        super(props, BogieStyles.SINGLE_AXLE_TRAILING, BogeySizes.SMALL);
    }
    @Override

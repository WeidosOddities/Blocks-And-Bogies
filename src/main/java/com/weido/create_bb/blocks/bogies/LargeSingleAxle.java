...
public class LargeSingleAxle extends LargeBogieBlock {
    public LargeSingleAxle(Properties props) {
        super(props, BogieStyles.SINGLE_AXLE_PISTONLESS, BogeySizes.SMALL);
    }
    @Override

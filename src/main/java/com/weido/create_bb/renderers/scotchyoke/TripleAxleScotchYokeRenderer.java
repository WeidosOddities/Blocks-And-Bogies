...
public class TripleAxleScotchYokeRenderer implements BogeyRenderer {
    @Override
    ...
    public static class TripleAxleLargeScotchYoke extends TripleAxleScotchYokeRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_6C_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.LARGE_6C_R_PIN, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_6C_L_PIN, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_6C_R_SLIDER, Blocks.AIR.defaultBlockState())
                    .translate(0, 0, .25f * Math.sin(AngleHelper.rad(wheelAngle)))
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.LARGE_6C_L_SLIDER, Blocks.AIR.defaultBlockState())
    ...
    public static class TripleAxleExtraLargeScotchYoke extends TripleAxleScotchYokeRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(bogeyData, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6C_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6C_R_PIN, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateXDegrees((wheelAngle))
                    .translate(0, .375f, 0)
                    .rotateXDegrees(-(wheelAngle))
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6C_L_PIN, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateXDegrees((wheelAngle+90))
                    .translate(0, .375f, 0)
                    .rotateXDegrees(-(wheelAngle+90))
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6C_R_SLIDER, Blocks.AIR.defaultBlockState())
                    .translate(0, 0, .375f * Math.sin(AngleHelper.rad(wheelAngle)))
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6C_L_SLIDER, Blocks.AIR.defaultBlockState())

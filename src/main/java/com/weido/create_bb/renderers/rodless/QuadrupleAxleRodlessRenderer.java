...
public class QuadrupleAxleRodlessRenderer implements BogeyRenderer {
    @Override
    ...
    public static class QuadrupleAxleLargeRodless extends QuadrupleAxleRodlessRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            SuperByteBuffer wheels_semi = CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_SEMI_BLIND_SINGLE, Blocks.AIR.defaultBlockState());
    ...
    public static class QuadrupleAxleExtraLargeRodless extends QuadrupleAxleRodlessRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(bogeyData, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            SuperByteBuffer wheels_semi = CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_WHEELS_SEMI_BLIND_SINGLE, Blocks.AIR.defaultBlockState());

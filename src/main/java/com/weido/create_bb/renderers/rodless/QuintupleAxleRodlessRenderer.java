...
public class QuintupleAxleRodlessRenderer implements BogeyRenderer {
    ...
    public static class QuintupleAxleLargeRodless extends QuintupleAxleRodlessRenderer {
        @Override
        public void render(CompoundTag compoundTag, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            SuperByteBuffer wheels1 = CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_SINGLE, Blocks.AIR.defaultBlockState());
            SuperByteBuffer wheels2 = CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_SEMI_BLIND_SINGLE, Blocks.AIR.defaultBlockState());
            ...
            CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_BLIND_SINGLE, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
    ...
    public static class QuintupleAxleExtraLargeRodless extends QuintupleAxleRodlessRenderer {
        @Override
        public void render(CompoundTag compoundTag, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(compoundTag, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            SuperByteBuffer wheels1 = CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_WHEELS_SINGLE, Blocks.AIR.defaultBlockState());
            SuperByteBuffer wheels2 = CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_WHEELS_SEMI_BLIND_SINGLE, Blocks.AIR.defaultBlockState());
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_WHEELS_BLIND_SINGLE, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateXDegrees(wheelAngle)
                    .light(light)
                    .overlay(overlay)

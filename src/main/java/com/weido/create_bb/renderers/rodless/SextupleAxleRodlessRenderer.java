...
public class SextupleAxleRodlessRenderer extends BlocksBogiesBogieRenderer {
    ...
    public static class SextuplesAxleLargeRodless extends SextupleAxleRodlessRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            SuperByteBuffer wheels2 = CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_BLIND_SINGLE, Blocks.AIR.defaultBlockState());
            SuperByteBuffer wheels3 = CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS_SEMI_BLIND_SINGLE, Blocks.AIR.defaultBlockState());

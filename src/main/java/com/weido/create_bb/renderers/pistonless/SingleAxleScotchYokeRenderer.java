...
public class SingleAxleScotchYokeRenderer implements BogeyRenderer {
    @Override
    ...
    public static class SingleAxleExtraLargeYokeRenderer extends SingleAxleScotchYokeRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_2C_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_2C_R_SLIDER, Blocks.AIR.defaultBlockState())
                    .translate(0, 0, .375f * Math.sin(AngleHelper.rad(wheelAngle)))
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_2C_L_SLIDER, Blocks.AIR.defaultBlockState())

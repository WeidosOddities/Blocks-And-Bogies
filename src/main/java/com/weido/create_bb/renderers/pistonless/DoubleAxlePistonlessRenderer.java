...
public class DoubleAxlePistonlessRenderer implements BogeyRenderer {
    @Override
    ...
    public static class DoubleAxleLargePistonless extends DoubleAxlePistonlessRenderer {
        @Override
        public void render(CompoundTag bogieData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_4P_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.LARGE_4P_R_C_ROD, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_4P_L_C_ROD, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
    ...
    public static class DoubleAxleExtraLargePistonless extends DoubleAxlePistonlessRenderer {
        @Override
        public void render(CompoundTag bogieData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(bogieData, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_4P_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .light(light)
                    .overlay(overlay)
                    .renderInto(poseStack, buffer);

            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_4P_R_C_ROD, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateXDegrees((wheelAngle))
                    .translate(0, .375f, 0)
                    .rotateXDegrees(-(wheelAngle))
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_4P_L_C_ROD, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateXDegrees((wheelAngle + 90))
                    .translate(0, .375f, 0)
                    .rotateXDegrees(-(wheelAngle + 90))

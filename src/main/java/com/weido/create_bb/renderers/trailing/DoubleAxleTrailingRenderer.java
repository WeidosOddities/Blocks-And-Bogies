...
public class DoubleAxleTrailingRenderer implements BogeyRenderer {
    @Override
    ...
    public static class DoubleAxleSmallTrailing extends DoubleAxleTrailingRenderer {
        @Override
        public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.SMALL_TRAILING_4_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)

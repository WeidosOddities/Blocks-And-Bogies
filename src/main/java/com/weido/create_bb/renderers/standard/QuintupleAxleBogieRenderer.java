...
public class QuintupleAxleBogieRenderer implements BogeyRenderer {
    @Override
    ...
    public static class SmallQuintupleAxleBogie extends QuintupleAxleBogieRenderer {
        public void render(CompoundTag compoundTag, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.SMALL_BOGIE_10_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .light(light)
                    .overlay(overlay)

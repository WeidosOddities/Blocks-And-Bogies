...
public class DoubleAxleExtraLongRenderer extends BlocksBogiesBogieRenderer {
    ...
    public static class DoubleAxleLargeExtraLong extends DoubleAxleExtraLongRenderer {
        ...
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_4LE_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_4LE_R_C_ROD : BogiePartials.LARGE_4LE_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderPistonRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_R_P_ROD_GEARLESS : BogiePartials.LARGE_L_P_ROD_GEARLESS, Blocks.AIR.defaultBlockState()), renderingResults);
            }
    ...
    public static class DoubleAxleExtraLargeExtraLong extends DoubleAxleExtraLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(forwards, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_4LE_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_4LE_R_C_ROD : BogiePartials.EXTRA_LARGE_4LE_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderPistonRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_R_P_ROD_GEARLESS : BogiePartials.EXTRA_LARGE_L_P_ROD_GEARLESS, Blocks.AIR.defaultBlockState()), renderingResults);
            }

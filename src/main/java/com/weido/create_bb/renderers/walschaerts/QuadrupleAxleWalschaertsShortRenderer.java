...
public class QuadrupleAxleWalschaertsShortRenderer extends BlocksBogiesBogieRenderer {
    @Override
    ...
    public static class QuadrupleAxleLargeWalschaertsShort extends QuadrupleAxleWalschaertsShortRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_8SW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_SHARED_ECCENTRIC_CRANK, Blocks.AIR.defaultBlockState())
                    .translate(0,LARGE_CENTER_HEIGHT, forwards ? LARGE_8S_OFFSET : -LARGE_8S_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_8SW_R_C_ROD : BogiePartials.LARGE_8SW_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_8SW_R_M_ROD : BogiePartials.LARGE_8SW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_8SW_R_R_ROD : BogiePartials.LARGE_8SW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_8SW_R_E_ROD : BogiePartials.LARGE_8SW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
    ...
    public static class QuadrupleAxleExtraLargeWalschaertsShort extends QuadrupleAxleWalschaertsShortRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(forwards, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_8SW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1 - 1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_ECCENTRIC_CRANK, Blocks.AIR.defaultBlockState())
                    .translate(0,EXTRA_LARGE_CENTER_HEIGHT, forwards ? EXTRA_LARGE_8S_OFFSET : -EXTRA_LARGE_8S_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_8SW_R_C_ROD : BogiePartials.EXTRA_LARGE_8SW_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_8SW_R_M_ROD : BogiePartials.EXTRA_LARGE_8SW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_8SW_R_R_ROD : BogiePartials.EXTRA_LARGE_8SW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_8SW_R_E_ROD : BogiePartials.EXTRA_LARGE_8SW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

...
public class SingleAxleWalschaertsLongRenderer extends BlocksBogiesBogieRenderer {
    @Override
    ...
    public static class SingleAxleLargeWalschaertsLong extends SingleAxleWalschaertsLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_2LW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_2P_BELTS, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)
            ...
            CachedBuffers.partial(BogiePartials.LARGE_SHARED_WHEELS, Blocks.AIR.defaultBlockState())
                    .translate(0, 1, 0)
                    .rotateYDegrees(forwards ? 0 : 180)
            ...
            for (int j : Iterate.positiveAndNegative) {
                shaft2.translate(-.5f, .25f, (j * -1)-.5f)
                        .center()
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_2LW_R_C_ROD : BogiePartials.LARGE_2LW_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_6SW_R_M_ROD : BogiePartials.LARGE_6SW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_6SW_R_E_ROD : BogiePartials.LARGE_6SW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_6SW_R_R_ROD : BogiePartials.LARGE_6SW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
    ...
    public static class SingleAxleExtraLargeWalschaertsLong extends SingleAxleWalschaertsLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(forwards, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_2LW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_2P_BELTS, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .light(light)
                    .overlay(overlay)
                    .shiftUVScrolling(AllSpriteShifts.BOGEY_BELT, scroll)
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_SHARED_WHEELS, Blocks.AIR.defaultBlockState())
                    .translate(0, 1.25f, 0)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .light(light)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_6SW_R_M_ROD : BogiePartials.EXTRA_LARGE_6SW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_6SW_R_R_ROD : BogiePartials.EXTRA_LARGE_6SW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_6SW_R_E_ROD : BogiePartials.EXTRA_LARGE_6SW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

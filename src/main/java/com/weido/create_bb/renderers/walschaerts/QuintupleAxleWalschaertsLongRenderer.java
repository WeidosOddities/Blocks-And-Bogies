...
public class QuintupleAxleWalschaertsLongRenderer extends BlocksBogiesBogieRenderer {
    @Override
    ...
    public static class QuintupleAxleLargeWalschaertsLong extends QuintupleAxleWalschaertsLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_10LW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_10LW_R_C_ROD : BogiePartials.LARGE_10LW_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_10LW_R_M_ROD : BogiePartials.LARGE_10LW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_10LW_R_R_ROD : BogiePartials.LARGE_10LW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_10LW_R_E_ROD : BogiePartials.LARGE_10LW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
    ...
    public static class QuintupleAxleExtraLargeWalschaertsLong extends QuintupleAxleWalschaertsLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(forwards, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_10LW_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_10LW_R_C_ROD : BogiePartials.EXTRA_LARGE_10LW_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

                renderMainRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_10LW_R_M_ROD : BogiePartials.EXTRA_LARGE_10LW_L_M_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderRadiusRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_10LW_R_R_ROD : BogiePartials.EXTRA_LARGE_10LW_L_R_ROD, Blocks.AIR.defaultBlockState()), renderingResults);
                ...
                renderEccentricRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_10LW_R_E_ROD : BogiePartials.EXTRA_LARGE_10LW_L_E_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

...
public class TripleAxleExtendedLongRenderer extends BlocksBogiesBogieRenderer {
    @Override
    ...
    public static class TripleAxleLargeExtendedLong extends TripleAxleExtendedLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_6LE_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_6LE_R_C_ROD : BogiePartials.LARGE_6LE_L_C_ROD, Blocks.AIR.defaultBlockState()),
                        renderingResults
                );
    ...
    public static class TripleAxleExtraLargeExtendedLong extends TripleAxleExtendedLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            super.render(forwards, wheelAngle, partialTick, poseStack, bufferSource, light, overlay, inContraption);
            ...
            CachedBuffers.partial(BogiePartials.EXTRA_LARGE_6LE_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.EXTRA_LARGE_6LE_R_C_ROD : BogiePartials.EXTRA_LARGE_6LE_L_C_ROD, Blocks.AIR.defaultBlockState()),
                        renderingResults
                );

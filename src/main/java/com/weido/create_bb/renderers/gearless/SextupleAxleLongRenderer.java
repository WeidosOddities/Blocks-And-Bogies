...
public class SextupleAxleLongRenderer extends BlocksBogiesBogieRenderer {
    ...
    public static class SextuplesAxleLargeLong extends SextupleAxleLongRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_12L_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_12L_R_C_ROD : BogiePartials.LARGE_12L_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

...
public class SextupleAxleShortRenderer extends BlocksBogiesBogieRenderer {
    ...
    public static class SextuplesAxleLargeShort extends SextupleAxleShortRenderer {
        @Override
        public void render(boolean forwards, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
            ...
            CachedBuffers.partial(BogiePartials.LARGE_12S_FRAME, Blocks.AIR.defaultBlockState())
                    .scale(1-1 / 512f)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .light(light)
                    .overlay(overlay)
            ...
            for (int i = 0; i < 2; i++) {
                ...
                renderConnectingRod(CachedBuffers.partial(i == 0 ? BogiePartials.LARGE_12S_R_C_ROD : BogiePartials.LARGE_12S_L_C_ROD, Blocks.AIR.defaultBlockState()), renderingResults);

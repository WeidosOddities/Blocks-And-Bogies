...
import static com.weido.create_bb.data.Constants.EXTRA_LARGE_6L_PISTON_DISTANCE;

public class TripleAxleLongVisual extends BlocksBogiesBogieVisual {
    public TripleAxleLongVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class TripleAxleLargeLong extends TripleAxleLongVisual {
        ...
        public TripleAxleLargeLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_6L_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_6L_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_6L_L_C_ROD))
                    .createInstance();
    ...
    public static class TripleAxleExtraLargeLong extends TripleAxleLongVisual {
        private final TransformedInstance frame;
        private final ScrollTransformedInstance belt;
        private final TransformedInstance r_c_rod;
        private final TransformedInstance l_c_rod;
        ...
        public TripleAxleExtraLargeLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_6L_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_6L_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_6L_L_C_ROD))
                    .createInstance();

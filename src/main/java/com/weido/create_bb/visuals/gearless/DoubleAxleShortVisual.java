...
public class DoubleAxleShortVisual extends BlocksBogiesBogieVisual {
    ...
    public static class DoubleAxleLargeShort extends DoubleAxleShortVisual {
        ...
        public DoubleAxleLargeShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_4S_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_4S_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_4S_L_C_ROD))
                    .createInstance();
    ...
    public static class DoubleAxleExtraLargeShort extends DoubleAxleShortVisual {
        ...
        public DoubleAxleExtraLargeShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_4S_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_4S_R_C_ROD))
                    .createInstance();

            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_4S_L_C_ROD))
                    .createInstance();

    ...
    public static class SextupleAxleLargeWalschaertsLong extends SextupleAxleWalschaertsLongVisual {
        ...
        public SextupleAxleLargeWalschaertsLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_L_C_ROD))
                    .createInstance();
            ...
            r_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_R_R_ROD))
                    .createInstance();
            l_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_L_R_ROD))
                    .createInstance();
            ...
            r_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_R_E_ROD))
                    .createInstance();
            l_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12LW_L_E_ROD))
                    .createInstance();

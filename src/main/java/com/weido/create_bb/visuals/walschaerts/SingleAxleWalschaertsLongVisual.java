...
public class SingleAxleWalschaertsLongVisual extends BlocksBogiesBogieVisual {
    ...
    public static class SingleAxleLargeWalschaertsLong extends SingleAxleWalschaertsLongVisual {
        ...
        public SingleAxleLargeWalschaertsLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_2LW_FRAME))
                    .createInstance();

            belt = ctx.instancerProvider()
                    .instancer(AllInstanceTypes.SCROLLING_TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_2P_BELTS))
                    .createInstance();

            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_2LW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_2LW_L_C_ROD))
                    .createInstance();
    ...
    public static class SingleAxleExtraLargeWalschaertsLong extends SingleAxleWalschaertsLongVisual {
        ...
        public SingleAxleExtraLargeWalschaertsLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_2LW_FRAME))
                    .createInstance();

            belt = ctx.instancerProvider()
                    .instancer(AllInstanceTypes.SCROLLING_TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_2P_BELTS))
                    .createInstance();

...
public class DoubleAxleWalschaertsShortVisual extends BlocksBogiesBogieVisual {
    public DoubleAxleWalschaertsShortVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class DoubleAxleLargeWalschaertsShort extends DoubleAxleWalschaertsShortVisual {
        ...
        public DoubleAxleLargeWalschaertsShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_L_C_ROD))
                    .createInstance();

            r_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_R_M_ROD))
                    .createInstance();
            l_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_L_M_ROD))
                    .createInstance();
            ...
            r_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_R_R_ROD))
                    .createInstance();
            l_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_L_R_ROD))
                    .createInstance();
            ...
            r_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_R_E_ROD))
                    .createInstance();
            l_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_4SW_L_E_ROD))
                    .createInstance();
        ...
        public void update(boolean forwards, float wheelAngle, PoseStack poseStack) {
            ...
            e_crank.setTransform(poseStack)
                    .translate(0, 1, forwards ? LARGE_4S_OFFSET : -LARGE_4S_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .setChanged();
    ...
    public static class DoubleAxleExtraLargeWalschaertsShort extends DoubleAxleWalschaertsShortVisual {
        private final TransformedInstance frame;
        private final ScrollTransformedInstance belt;
        private final TransformedInstance r_c_rod;
        private final TransformedInstance l_c_rod;
        ...
        public DoubleAxleExtraLargeWalschaertsShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_R_C_ROD))
                    .createInstance();

            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_L_C_ROD))
                    .createInstance();

            r_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_R_M_ROD))
                    .createInstance();
            l_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_L_M_ROD))
                    .createInstance();
            ...
            r_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_R_R_ROD))
                    .createInstance();
            l_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_L_R_ROD))
                    .createInstance();
            ...
            r_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_R_E_ROD))
                    .createInstance();
            l_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_4SW_L_E_ROD))
                    .createInstance();
        ...
        public void update(boolean forwards, float wheelAngle, PoseStack poseStack) {
            ...
            e_crank.setTransform(poseStack)
                    .translate(0, 1.25f, forwards ? EXTRA_LARGE_4S_OFFSET : -EXTRA_LARGE_4S_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .setChanged();

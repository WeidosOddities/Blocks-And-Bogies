...
public class QuadrupleAxleWalschaertsLongVisual extends BlocksBogiesBogieVisual {
    public QuadrupleAxleWalschaertsLongVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class QuadrupleAxleLargeWalschaertsLong extends QuadrupleAxleWalschaertsLongVisual {
        ...
        public QuadrupleAxleLargeWalschaertsLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_L_C_ROD))
                    .createInstance();

            r_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_R_M_ROD))
                    .createInstance();
            l_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_L_M_ROD))
                    .createInstance();

            r_p_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_R_P_ROD_WALSCHAERTS))
                    .createInstance();
            l_p_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_L_P_ROD_WALSCHAERTS))
                    .createInstance();

            r_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_R_R_ROD))
                    .createInstance();
            l_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_L_R_ROD))
                    .createInstance();

            r_e_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_R_E_LINK))
                    .createInstance();
            l_e_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_L_E_LINK))
                    .createInstance();

            r_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_R_E_ROD))
                    .createInstance();
            l_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_8LW_L_E_ROD))
                    .createInstance();

            r_c_lever = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_R_C_LEVER))
                    .createInstance();
            l_c_lever = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_L_C_LEVER))
                    .createInstance();

            r_u_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_R_U_LINK))
                    .createInstance();
            l_u_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_L_U_LINK))
                    .createInstance();

            r_v_stem = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_R_V_STEM))
                    .createInstance();
            l_v_stem = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_L_V_STEM))
                    .createInstance();

            e_crank = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_SHARED_ECCENTRIC_CRANK))
                    .createInstance();
        ...
        public void update(boolean forwards, float wheelAngle, PoseStack poseStack) {
            ...
            e_crank.setTransform(poseStack)
                    .translate(0, 1, forwards ? LARGE_8L_OFFSET : -LARGE_8L_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .setChanged();

            shaft1.setTransform(poseStack)
                    .translate(-.5f, .25f, -4.125f)
                    .center()
    ...
    public static class QuadrupleAxleExtraLargeWalschaertsLong extends QuadrupleAxleWalschaertsLongVisual {
        private final TransformedInstance frame;
        private final ScrollTransformedInstance belt;
        private final TransformedInstance r_c_rod;
        private final TransformedInstance l_c_rod;
        ...
        public QuadrupleAxleExtraLargeWalschaertsLong(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_L_C_ROD))
                    .createInstance();

            r_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_R_M_ROD))
                    .createInstance();
            l_m_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_L_M_ROD))
                    .createInstance();

            r_p_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_R_P_ROD_WALSCHAERTS))
                    .createInstance();
            l_p_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_L_P_ROD_WALSCHAERTS))
                    .createInstance();

            r_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_R_R_ROD))
                    .createInstance();
            l_r_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_L_R_ROD))
                    .createInstance();

            r_e_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_R_E_LINK))
                    .createInstance();
            l_e_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_L_E_LINK))
                    .createInstance();

            r_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_R_E_ROD))
                    .createInstance();
            l_e_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_8LW_L_E_ROD))
                    .createInstance();

            r_c_lever = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_R_C_LEVER))
                    .createInstance();
            l_c_lever = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_L_C_LEVER))
                    .createInstance();

            r_u_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_R_U_LINK))
                    .createInstance();
            l_u_link = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_L_U_LINK))
                    .createInstance();

            r_v_stem = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_R_V_STEM))
                    .createInstance();
            l_v_stem = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_L_V_STEM))
                    .createInstance();

            e_crank = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_SHARED_ECCENTRIC_CRANK))
                    .createInstance();
        ...
        RodCalculations.WalschaertsParameters params = new RodCalculations.WalschaertsParameters(
                ...
                EXTRA_LARGE_VALVE_Y,
                EXTRA_LARGE_8L_PISTON_DISTANCE,
                EXTRA_LARGE_CENTER_HEIGHT,
                EXTRA_LARGE_8L_OFFSET
        );
        ...
        public void update(boolean forwards, float wheelAngle, PoseStack poseStack) {
            ...
            e_crank.setTransform(poseStack)
                    .translate(0, 1.25f, forwards ? EXTRA_LARGE_8L_OFFSET : -EXTRA_LARGE_8L_OFFSET)
                    .rotateYDegrees(forwards ? 0 : 180)
                    .rotateXDegrees(forwards ? wheelAngle : -wheelAngle)
                    .setChanged();

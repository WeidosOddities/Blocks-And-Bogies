...
public class TripleAxleExtendedWalschaertsShortVisual extends BlocksBogiesBogieVisual {
    ...
    public static class TripleAxleLargeExtendedWalschaertsShort extends TripleAxleExtendedWalschaertsShortVisual {
        ...
        public TripleAxleLargeExtendedWalschaertsShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_6SEW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_6SEW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_6SEW_L_C_ROD))
                    .createInstance();
    ...
    public static class TripleAxleExtraLargeExtendedWalschaertsShort extends TripleAxleExtendedWalschaertsShortVisual {
        ...
        public TripleAxleExtraLargeExtendedWalschaertsShort(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_6SEW_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_6SEW_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_6SEW_L_C_ROD))
                    .createInstance();

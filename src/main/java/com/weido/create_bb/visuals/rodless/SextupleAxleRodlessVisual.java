...
public class SextupleAxleRodlessVisual implements BogeyVisual {
    public SextupleAxleRodlessVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class SextupleAxleLargeRodless extends SextupleAxleRodlessVisual {
        ...
        public SextupleAxleLargeRodless(VisualizationContext ctx, float partialTick, boolean inContraption) {

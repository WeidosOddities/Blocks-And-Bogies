...
public class QuintupleAxleRodlessVisual implements BogeyVisual {
    public QuintupleAxleRodlessVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class QuintupleAxleLargeRodless extends QuintupleAxleRodlessVisual {
        ...
        public QuintupleAxleLargeRodless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            var wheelBlindInstancer = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_SHARED_WHEELS_BLIND_SINGLE));
    ...
    public static class QuintupleAxleExtraLargeRodless extends QuintupleAxleRodlessVisual {
        private final TransformedInstance frame;
        private final ScrollTransformedInstance belt;
        private final TransformedInstance wheel1;
        private final TransformedInstance wheel2;
        ...
        public QuintupleAxleExtraLargeRodless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);
            ...
            var wheelBlindInstancer = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_SHARED_WHEELS_BLIND_SINGLE));

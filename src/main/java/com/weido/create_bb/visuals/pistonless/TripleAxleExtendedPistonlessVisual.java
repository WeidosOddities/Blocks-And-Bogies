...
public class TripleAxleExtendedPistonlessVisual extends BlocksBogiesBogieVisual {
    ...
    public static class TripleAxleLargeExtendedPistonless extends TripleAxleExtendedPistonlessVisual {
        ...
        public TripleAxleLargeExtendedPistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_6EP_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.LARGE_6EP_L_C_ROD))
                    .createInstance();
    ...
    public static class TripleAxleExtraLargeExtendedPistonless extends TripleAxleExtendedPistonlessVisual {
        ...
        public TripleAxleExtraLargeExtendedPistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_6EP_R_C_ROD))
                    .createInstance();
            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, SpecialModels.smoothLit(BogiePartials.EXTRA_LARGE_6EP_L_C_ROD))
                    .createInstance();

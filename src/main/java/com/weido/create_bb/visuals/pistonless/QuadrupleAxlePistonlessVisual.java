...
public class QuadrupleAxlePistonlessVisual implements BogeyVisual {
    public QuadrupleAxlePistonlessVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class QuadrupleAxleLargePistonless extends QuadrupleAxlePistonlessVisual {
        ...
        public QuadrupleAxleLargePistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
    ...
    public static class QuadrupleAxleExtraLargePistonless extends QuadrupleAxlePistonlessVisual {
        private final TransformedInstance frame;
        private final ScrollTransformedInstance belt;
        private final TransformedInstance r_c_rod;
        private final TransformedInstance l_c_rod;
        ...
        public QuadrupleAxleExtraLargePistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            super(ctx, partialTick, inContraption);

...
public class QuintupleAxlePistonlessVisual implements BogeyVisual {
    ...
    public static class QuintupleAxleLargePistonless extends QuintupleAxlePistonlessVisual {
        ...
        public QuintupleAxleLargePistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_10P_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_10P_R_C_ROD))
                    .createInstance();

            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_10P_L_C_ROD))
                    .createInstance();
    ...
    public static class QuintupleAxleExtraLargePistonless extends QuintupleAxlePistonlessVisual {
        ...
        public QuintupleAxleExtraLargePistonless(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_10P_FRAME))
                    .createInstance();
            ...
            r_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_10P_R_C_ROD))
                    .createInstance();

            l_c_rod = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.EXTRA_LARGE_10P_L_C_ROD))
                    .createInstance();

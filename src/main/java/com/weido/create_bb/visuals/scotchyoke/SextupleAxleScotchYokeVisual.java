    ...
    public static class SextupleAxleLargeScotchYoke extends SextupleAxleScotchYokeVisual {
        ...
        public SextupleAxleLargeScotchYoke(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            frame = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12C_FRAME))
                    .createInstance();
            ...
            r_pin = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12C_R_PIN))
                    .createInstance();
            l_pin = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12C_L_PIN))
                    .createInstance();

            r_slider = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12C_R_SLIDER))
                    .createInstance();
            l_slider = ctx.instancerProvider()
                    .instancer(InstanceTypes.TRANSFORMED, Models.partial(BogiePartials.LARGE_12C_L_SLIDER))
                    .createInstance();

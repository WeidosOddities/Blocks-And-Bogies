...
public class DoubleAxleTrailingVisual implements BogeyVisual {
    ...
    public static class DoubleAxleSmallTrailing extends DoubleAxleTrailingVisual {
        ...
        public DoubleAxleSmallTrailing(VisualizationContext ctx, float partialTick, boolean inContraption) {
            ...
            shaft3 = t_shaftInstancer.createInstance();
            shaft4 = t_shaftInstancer.createInstance();
        }

...
public class QuadrupleAxleTrailingVisual implements BogeyVisual {
    public QuadrupleAxleTrailingVisual(VisualizationContext ctx, float partialTick, boolean inContraption) { }
    @Override
    ...
    public static class QuadrupleAxleSmallTrailing extends QuadrupleAxleTrailingVisual {
        ...
        public final TransformedInstance shaft6;
        ...
        public QuadrupleAxleSmallTrailing(VisualizationContext ctx, float partialTick, boolean inContraption) {
